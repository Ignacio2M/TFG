...
class SR:
    ...
    def init_sr(self, images_path: list, num_samples, take_range=None, **kwargs):
        ...
        # _________________ Guardado de informacion _________________
